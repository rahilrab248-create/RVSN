...
export const featuredBoots: ShowcaseItem[] = [
  {
    ...
    meta: "Explosive acceleration",
    href: "/products/aero-phantom-fg",
    imageUrl: "/images/products/aero-phantom-fg.avif",
  },
  {
    name: "Control Matrix Elite",
    label: "Touch",
    ...
    meta: "Grip-textured upper",
    href: "/products/control-matrix-elite",
    imageUrl: "/images/products/control-matrix-elite.webp",
  },
  {
    name: "Predator Pulse Pro",
    label: "Power",
    ...
    meta: "Strike-zone plate",
    href: "/products/predator-pulse-pro",
